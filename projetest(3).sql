...
--
-- Hôte : 127.0.0.1
-- Généré le :  lun. 16 déc. 2019 à 14:41
...
('Astral Inn', 0, 3, 'Leipzig', 'IMG/astral.png'),
('C2', 0, 5, 'Marseille', 'IMG/C2.png'),
('Darcet', 3, 2, 'Paris', 'IMG/Darcet.png'),
('Dorsett City London', 0, 4, 'Londres', 'IMG/dorsett.png\r\n'),
('Fred Hotel', 2, 3, 'Paris', 'IMG/fred.png'),
('Hermes', 0, 2, 'Marseille', 'IMG/hermes.png'),
('Hotel de Belgique', 0, 1, 'Paris', 'IMG/hdb.png'),
('Ibis', 0, 1, 'Lisbonne', 'IMG/ibis.png'),
('La manufacture', 3, 3, 'Paris', 'IMG/manufacture.png'),
('Les jardins de mademoiselle', 2, 4, 'Paris', 'IMG/jardins.png'),
('Maritim Hotel', 0, 4, 'Berlin', 'IMG/maritim.png'),
('nhow', 0, 3, 'Berlin', 'IMG/nhow.png'),
('Radisson Blu Hotel', 0, 4, 'Berlin', 'IMG/radisson.png'),
('Roda Al Murooj', 0, 5, 'Dubai', 'IMG/roda.png'),
('Saint Ferreol', 0, 3, 'Marseille', 'IMG/saint.png'),
('Shangri-La Hotel', 0, 5, 'Dubai', 'IMG/shangrila.png'),
('The Nadler Covent Garden', 0, 5, 'Londres', 'IMG/nadler.png'),
('The Tower', 0, 4, 'Londres', 'IMG/tower.png'),
('Wyndham Dubai Marina', 0, 4, 'Dubai', 'IMG/w.png');
